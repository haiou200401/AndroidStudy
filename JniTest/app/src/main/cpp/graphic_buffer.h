...
struct GraphicBufferFunctions {
    ...
    typedef int32_t				    (*initCheckFunc)		(android::GraphicBuffer* buffer);
    typedef int32_t				    (*lockFunc)				(android::GraphicBuffer* buffer, uint32_t usage, void** vaddr);
    typedef int32_t				    (*unlockFunc)			(android::GraphicBuffer* buffer);
...
public:
    ...
    int32_t initCheck();
    int32_t lock(uint32_t usage, void** vaddr);
    int32_t unlock();
