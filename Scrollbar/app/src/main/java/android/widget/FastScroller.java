...
//
    ...
    private void beginDrag() {
        ...
        if (mList != null) {
            ...
            try {
                // gloam:
                mReportScrollStateChangeMethod.invoke(mList, OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (mState == STATE_DRAGGING) {
                    if (mList != null) {
                        ...
                        try {
                            // gloam:
                            mReportScrollStateChangeMethod.invoke(mList, OnScrollListener.SCROLL_STATE_IDLE);
