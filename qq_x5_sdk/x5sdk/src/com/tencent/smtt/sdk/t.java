...
class t extends WebViewClient {
    ...
    private class e implements WebResourceRequest {
        ...
        public e(t tVar, String str, boolean z, boolean z2, String str2, Map<String, String> map) {
            this.a = tVar;
            this.b = str;
            this.c = z;
            this.d = z2;
    ...
    t(WebView webView, WebViewClient webViewClient) {
        this.b = webView;
    ...
    public void onReceivedError(WebView webView, android.webkit.WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (webResourceError != null) {
            aVar = new v(this, webResourceError);
        }
