...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        if (ao.a().b() || VERSION.SDK_INT < 17) {
            return null;
        }
        Object a = g.a(android.webkit.WebSettings.class, "getDefaultUserAgent", new Class[]{Context.class}, context);
    ...
    public boolean enableSmoothTransition() {
        ...
        Object a = g.a(this.b, "enableSmoothTransition");
    ...
    public boolean getAllowContentAccess() {
        ...
        Object a = g.a(this.b, "getAllowContentAccess");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public boolean getDisplayZoomControls() {
        ...
        Object a = g.a(this.b, "getDisplayZoomControls");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public boolean getMediaPlaybackRequiresUserGesture() {
        ...
        Object a = g.a(this.b, "getMediaPlaybackRequiresUserGesture");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public synchronized int getMixedContentMode() {
        ...
        synchronized (this) {
            if (this.c && this.a != null) {
                ...
                Object a = g.a(this.b, "getMixedContentMode", new Class[0], new Object[0]);
    ...
    public synchronized PluginState getPluginState() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = g.a(this.b, "getPluginState");
        ...
        synchronized (this) {
            if (this.c && this.a != null) {
                ...
                if (VERSION.SDK_INT <= 17) {
                    Object a = g.a(this.b, "getPluginsEnabled");
    ...
    public synchronized String getPluginsPath() {
        ...
        if (this.c && this.a != null) {
            ...
            Object a = g.a(this.b, "getPluginsPath");
    ...
    public synchronized int getTextZoom() {
        ...
        synchronized (this) {
            if (this.c && this.a != null) {
                ...
                Object a = g.a(this.b, "getTextZoom");
    ...
    public boolean getUseWebViewBackgroundForOverscrollBackground() {
        ...
        Object a = g.a(this.b, "getUseWebViewBackgroundForOverscrollBackground");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public void setAllowContentAccess(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setAllowContentAccess", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowFileAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setAllowFileAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowUniversalAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setAllowUniversalAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setDatabasePath(String str) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setDatabasePath", new Class[]{String.class}, str);
        }
    }
    ...
    public void setDisplayZoomControls(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setDisplayZoomControls", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setEnableSmoothTransition(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setEnableSmoothTransition", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMediaPlaybackRequiresUserGesture(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setMediaPlaybackRequiresUserGesture", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMixedContentMode(int i) {
        if ((!this.c || this.a == null) && !this.c && this.b != null && VERSION.SDK_INT >= 21) {
            g.a(this.b, "setMixedContentMode", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setPluginState", new Class[]{android.webkit.WebSettings.PluginState.class}, valueOf);
        }
    }
    ...
    public void setPluginsEnabled(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setPluginsEnabled", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setPluginsPath", new Class[]{String.class}, str);
        }
    }
    ...
    public synchronized void setTextZoom(int i) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setTextZoom", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
    ...
    public void setUseWebViewBackgroundForOverscrollBackground(boolean z) {
        if (this.c && this.a != null) {
            ...
            g.a(this.b, "setUseWebViewBackgroundForOverscrollBackground", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
