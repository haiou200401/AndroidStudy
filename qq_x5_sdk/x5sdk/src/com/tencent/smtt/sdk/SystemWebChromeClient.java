...
class SystemWebChromeClient extends WebChromeClient {
    ...
    public void getVisitedHistory(ValueCallback<String[]> valueCallback) {
        this.b.getVisitedHistory(new o(this, valueCallback));
    }
    ...
    public boolean onCreateWindow(WebView webView, boolean z, boolean z2, Message message) {
        ...
        Message obtain = Message.obtain(message.getTarget(), new p(this, webViewTransport, message));
    ...
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, FileChooserParams fileChooserParams) {
        ValueCallback rVar = new r(this, valueCallback);
        WebChromeClient.FileChooserParams sVar = new s(this, fileChooserParams);
        this.a.a(webView);
        return this.b.onShowFileChooser(this.a, rVar, sVar);
    }
    ...
    public void openFileChooser(ValueCallback<Uri> valueCallback, String str, String str2) {
        this.b.openFileChooser(new q(this, valueCallback), str, str2);
    }
